...
export const experiences: {
...
}[] = [
    {
        ...
        description: `
        Developed and maintained web and mobile applications using various technologies, including Spring Boot, React, Angular, and Flutter. 
        Collaborated with clients to understand their requirements and deliver high-quality solutions.
        Implement responsive and accessible user interfaces to enhance user experience.
        `,
    ...
    },
    {
        ...
        description: `
        Build a mobile app designed to make daily shopping easier by helping users compare prices from different supermarkets in one place. 
        With a simple, user-friendly interface, the app allows people to check for the best deals on groceries and household items, saving time and money. 
        Users can access updated prices and make informed choices about where to shop, all from the convenience of their mobile phones.
        `,
    ...
    },
    {
        ...
        description: `
        The medical blog platform is a dedicated website for doctors and healthcare professionals to share, publish, and discuss medical topics and discoveries. 
        It provides a space for experts to post articles, engage in discussions, and stay updated on the latest in healthcare, making a collaborative medical community.
        `,
