...
export const certifs: {
...
}[] = [
    {
        ...
        badge: '/assets/certifs/pcap-31-03.jpg'
    },
    {
        title: 'EF SET Certificate',
        url:'https://cert.efset.org/JEfU1h',
        badge: '/assets/certifs/ef-set-english.jpg'
    }
];
...
export const projects: {
...
}[] = [
    {
        ...
        images: [
            '/assets/demos/pod-studio/auth-login.jpg',
            '/assets/demos/pod-studio/auth-register.jpg',
            '/assets/demos/pod-studio/client-home.jpg',
            '/assets/demos/pod-studio/client-studio.jpg',
            '/assets/demos/pod-studio/client-bookings.jpg',
            '/assets/demos/pod-studio/client-profile.jpg',
            '/assets/demos/pod-studio/admin-bookings-edit.jpg',
            '/assets/demos/pod-studio/admin-bookings-index.jpg',
            '/assets/demos/pod-studio/admin-clients-index.jpg',
            '/assets/demos/pod-studio/admin-dashboard.jpg',
            '/assets/demos/pod-studio/admin-equipments-create.jpg',
            '/assets/demos/pod-studio/admin-equipments-edit.jpg',
            '/assets/demos/pod-studio/admin-equipments-index.jpg',
            '/assets/demos/pod-studio/admin-packages-create.jpg',
            '/assets/demos/pod-studio/admin-packages-edit.jpg',
            '/assets/demos/pod-studio/admin-packages-index.jpg',
            '/assets/demos/pod-studio/admin-studios-create.jpg',
            '/assets/demos/pod-studio/admin-studios-edit.jpg',
            '/assets/demos/pod-studio/admin-studios-index.jpg',
        ],
    },
    {
        ...
        images: [
            '/assets/demos/java-resto/Screenshot_20260518_195046.jpg',
            '/assets/demos/java-resto/Screenshot_20260518_195115.jpg',
            '/assets/demos/java-resto/Screenshot_20260518_195135.jpg',
            '/assets/demos/java-resto/Screenshot_20260518_195335.jpg',
            '/assets/demos/java-resto/Screenshot_20260518_195411.jpg',
            '/assets/demos/java-resto/Screenshot_20260518_195443.jpg',
            '/assets/demos/java-resto/Screenshot_20260518_195453.jpg',
            '/assets/demos/java-resto/Screenshot_20260518_195459.jpg',
            '/assets/demos/java-resto/Screenshot_20260518_195504.jpg',
        ],
    },
    {
