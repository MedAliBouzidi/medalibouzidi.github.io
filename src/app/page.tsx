    ...
    return (
        <div className="flex flex-col min-h-screen bg-gradient-to-b from-gray-900 to-gray-800 text-gray-100">
            ...
            <main className="flex-1 pt-16">
                <section id="about"
                    ...
                    <div className="absolute w-full h-full opacity-30 overflow-hidden ">
                        <motion.div
                            ...
                            initial={{scale: 0.5}}
                            animate={{scale: 1.25}}
                            style={{width: '150vh', height: '150vh', filter: 'blur(50px)'}}
                            transition={{
                                duration: 2,
                                ease: "easeInOut",
                                repeat: Infinity,
                        ...
                        />
                        <motion.div
                            className="absolute bottom-1/2 right-2/3 bg-gradient-to-r from-blue-600 via-green-600 to-yellow-600 rounded-full opacity-30"
                            initial={{scale: 0.5}}
                            animate={{scale: 1.25}}
                            style={{width: '150vh', height: '150vh', filter: 'blur(50px)'}}
                            transition={{
                        ...
                        <div className="flex flex-col items-center space-y-4 text-center">
                            <div className="space-y-2">
                                ...
                                <p className="mx-auto max-w-[700px] text-gray-400 md:text-xl lg:text-2xl">
                                    Full Stack Developer passionate about creating web applications that make a
                                    difference.
                                </p>
                            </div>
                            <div className="space-x-4">
                                ...
                                <Link href={"#projects"}>
                                    <Button variant="outline"
                                            className="bg-gray-800 text-white hover:bg-gray-700 border-gray-700 transition-colors">View
                                        Projects
                                    </Button>
                                </Link>
                            </div>
                            ...
                            {technicalSkills.map((category, index) => (
                                ...
                                >
                                    <Card
                                        ...
                                        <CardHeader>
                                            <CardTitle className="text-white flex items-center gap-x-3">
                ...
                <section id="projects"
                         className="flex justify-center w-full py-12 md:py-24 lg:py-32 border-b border-gray-800">
                                ...
                                >
                                    <Card
                                        ...
                                        <CardHeader>
                                            ...
                                            <CardDescription
                                                className="text-gray-400">{project.description}</CardDescription>
                                        </CardHeader>
                                        <CardContent>
                ...
                <section id="resume"
                         className="flex justify-center w-full py-12 md:py-24 lg:pb-32 lg:pt-5 bg-gray-800/30">
                    <div
                        className="container flex flex-col lg:flex-row items-center justify-center gap-x-20 px-4 md:px-6">
                        <motion.div {...fadeInUp}>
                            <motion.h2
